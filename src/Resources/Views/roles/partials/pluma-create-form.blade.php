{!! Form::model($model = new \Caffeinated\Shinobi\Models\Role, ['method' => 'POST', 'route' => $store_route, 'class' => 'Formulario-Horizontal']) !!}
  <section>
    ...
    <div class="Caja-Tabla Compensar-Padding-Layout">
      <table class="Tabla Responsive Tabla-Rayada">
        ...
        @foreach($permissions as $permission)
          <tr>
            <td><label class="Checkbox-Inline">{!! Form::checkbox('permissions['.$permission->id.']', null, false) !!}</label></td>
