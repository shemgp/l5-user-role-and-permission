...
class ViewComposerServiceProvider extends ServiceProvider
{
    ...
    {
        view()->composer($this->module.'partials.header', 'RafflesArgentina\UserRoleAndPermission\Http\ViewComposers\LayoutPartialsComposer@composeHeader');
    ...
    {
        view()->composer($this->module.$this->resourceName.'.index', 'RafflesArgentina\UserRoleAndPermission\Http\ViewComposers\UsersComposer@composeIndex');
        ...
        view()->composer($this->module.$this->resourceName.'.create', 'RafflesArgentina\UserRoleAndPermission\Http\ViewComposers\UsersComposer@composeCreate');
        ...
        view()->composer($this->module.$this->resourceName.'.show', 'RafflesArgentina\UserRoleAndPermission\Http\ViewComposers\UsersComposer@composeShow');
        ...
        view()->composer($this->module.$this->resourceName.'.edit', 'RafflesArgentina\UserRoleAndPermission\Http\ViewComposers\UsersComposer@composeEdit');
    ...
    {
        view()->composer($this->module.$this->roleResourceName.'.index', 'RafflesArgentina\UserRoleAndPermission\Http\ViewComposers\RolesComposer@composeIndex');
        ...
        view()->composer($this->module.$this->roleResourceName.'.create', 'RafflesArgentina\UserRoleAndPermission\Http\ViewComposers\RolesComposer@composeCreate');
        ...
        view()->composer($this->module.$this->roleResourceName.'.show', 'RafflesArgentina\UserRoleAndPermission\Http\ViewComposers\RolesComposer@composeShow');
        ...
        view()->composer($this->module.$this->roleResourceName.'.edit', 'RafflesArgentina\UserRoleAndPermission\Http\ViewComposers\RolesComposer@composeEdit');
